"""Update the Lexington Gays blog with current event data.
...
<head>
    ...
    <title>Lexington Gays - Your Weekly LGBTQ+ Event Guide for Lexington</title>
    <meta name="description" content="Lexington Gays is your weekly LGBTQ+ event guide for Lexington, KY. Find queer events, pride happenings, drag shows, community gatherings, and more.">
    <meta name="keywords" content="Lexington LGBTQ events, Lexington gay events, Lexington pride, queer Lexington, Lexington drag shows, LGBTQ Oklahoma, Lexington nightlife, Homo Hotel Happy Hour, OKEQ events">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Lexington Gays - Weekly LGBTQ+ Events">
    <meta property="og:description" content="Your weekly guide to LGBTQ+ events in Lexington, KY. Community gatherings, nightlife, arts, and more.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://lexingtongays.github.io">
    <meta property="og:site_name" content="Lexington Gays">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Lexington Gays - Weekly LGBTQ+ Events">
    <meta name="twitter:description" content="Your weekly guide to LGBTQ+ events in Lexington, KY.">
...
<body>
    <header class="site-header">
        <div class="header-inner">
            <a href="index.html" class="logo-area">
                <div>
                    <div class="logo-text">Lexington Gays</div>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="https://instagram.com/lexingtongays" target="_blank" rel="noopener">Instagram</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <footer class="site-footer">
        <div class="footer-inner">
            <p>Follow us on Instagram: <a href="https://instagram.com/lexingtongays" target="_blank" rel="noopener">@lexingtongays</a></p>
            <p>Updated weekly &middot; Your guide to LGBTQ+ Lexington</p>
        </div>
    </footer>
</body>
</html>"""
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Event Archive - Lexington Gays</title>
    <meta name="description" content="Archive of past LGBTQ+ events in Lexington, KY.">
    <meta property="og:title" content="Event Archive - Lexington Gays">
    <meta property="og:description" content="Browse past weeks' LGBTQ+ event guides for Lexington, KY.">
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header class="site-header">
    ...
    <main class="container">
        <div class="week-header">
            <h1>Event Archive</h1>
            <p class="date-range">Browse past weeks' LGBTQ+ events in Lexington</p>
            <div class="rainbow-bar rainbow-gradient"></div>
        </div>
