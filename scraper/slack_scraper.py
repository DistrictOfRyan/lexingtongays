"""Slack channel event scraper for LexingtonRemote workspace.

Scrapes event posts from:
- #events-local: Local Lexington events posted by community members
...
# Slack channel IDs for LexingtonRemote workspace
SLACK_CHANNELS = {
...
class SlackScraper(BaseScraper):
    """Scraper for LexingtonRemote Slack event channels."""
    ...
    def extract_event_from_message(self,
        ...
        - "Event Name coming to Lexington! March 31, 7:30 PM at venue"
        """
