...
Covers major Lexington venues: BOK Center, Cain's Ballroom, Hard Rock Live, TPAC,
...
# Lexington-area venue search URLs for web-scraping fallback
SONGKICK_LEXINGTON = "https://www.songkick.com/metro-areas/29100-us-lexington"
DO918_EVENTS = "https://do918.com/events"
AXS_BOK = "https://www.axs.com/venues/101571/bok-center-lexington-tickets"
...
class TicketingScraper(BaseScraper):
    """Scrape major ticketing platforms for Lexington events this week."""
    ...
    def _scrape_songkick(self, monday: datetime, sunday: datetime) -> List[Dict]:
        """Extract upcoming Lexington concerts from Songkick's metro page."""
        soup = self.fetch_page(SONGKICK_LEXINGTON)
        if not soup:
            return []
        ...
        json_ld_events = self._extract_json_ld_from_soup(soup, SONGKICK_LEXINGTON, priority=3)
        if json_ld_events:
    ...
    def _scrape_do918(self, monday: datetime, sunday: datetime) -> List[Dict]:
        """Scrape Do918 — Lexington's local event guide."""
