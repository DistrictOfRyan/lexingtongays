...
class CommunityGroupsScraper(BaseScraper):
    ...
    SOURCES = {
        ...
        # via the authenticated instagrapi session. s66lexington.com is a dead domain
        ...
        # lexington_house_of_drag RETIRED 2026-06-18: lexingtonhouseofdrag.com is NXDOMAIN.
