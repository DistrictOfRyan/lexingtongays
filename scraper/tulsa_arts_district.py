"""Scraper for Lexington Arts District events."""
...
class LexingtonArtsDistrictScraper(BaseScraper):
    """Scrape events from thelexingtonartsdistrict.org/events/list/."""

    source_name = "lexington_arts_district"

    BASE_URL = "https://thelexingtonartsdistrict.org"
    EVENTS_URL = "https://thelexingtonartsdistrict.org/events/list/"
    ...
    def _extract_events(self, soup) -> List[Dict]:
        """Extract events from the Lexington Arts District events page.
...
def scrape() -> List[Dict]:
    ...
    return LexingtonArtsDistrictScraper().safe_scrape()
