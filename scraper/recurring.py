"""Hardcoded recurring LGBTQ+ events for Lexington.
...
RECURRING = [
    ...
    {
        "name": "OSU Lexington Queer Support Group",
        "day": "Tuesday",
        "freq": "weekly",
        "time": "6:00 PM",
        "venue": "OSU Lexington Campus, 700 N Greenwood Ave",
        "url": "https://events.lexington.okstate.edu",
        "priority": 1,
    },
    {
    ...
    },
    {
        ...
        "venue": "Fellowship Congregational Church, Lexington",
    ...
    },
    {
        ...
        "venue": "Club Majestic, 124 N Boston Ave",
        "url": "https://qlist.app/events/Lexington/The-Sunday-Showdown-Open-Talent-Night-at-Club-Majestic/16808",
        "priority": 1,
    },
    {
    ...
    # 1st occurrence of the month
    {
        ...
        "venue": "DoubleTree by Hilton Lexington Downtown, 616 W 7th St",
    ...
    },
    {
        ...
        "freq": "1st",
        "time": "7:00 PM",
        "venue": "110 S Hartford Ave, Lexington",
        "url": "https://pflag.org/chapter/pflag-lexington",
        "priority": 1,
    },
    {
    ...
    {
        "name": "Black Queer Lexington Monthly Brunch",
        "day": "Sunday",
        "freq": "3rd",
        "time": "Check website for time",
        "venue": "Various locations, Lexington",
        "url": "https://www.blackqueerlexington.org/events",
        "priority": 1,
    },
]
