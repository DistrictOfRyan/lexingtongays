...
Channels scraped:
  - #events-local (CGV2YLJSG): General Lexington community events. All included —
    the queer community shows up for all of Lexington, not just LGBTQ-tagged events.
  - #unite-lgbtq-plus (CU36YG88K): LGBTQ+-specific events.

Workspace: LexingtonRemote (TF1E6FCR5)
Deep-link: https://lexingtonremote.slack.com/archives/CGV2YLJSG
...
HOW TO EXTRACT (for SKILL.md / Claude-in-Chrome):
  ...
  4. Extract events — look for:
     ...
     - URLs (Eventbrite, givebutter, experiencelexington, etc.)
