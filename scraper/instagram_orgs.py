...
ORGS: List[Dict] = [
    # Lexington gay bars whose events live primarily on Instagram (verified real
    # 2026-06-19). The Bar Complex's website has no calendar; Crossings' site is
    # NXDOMAIN. IG is where they post shows, so scrape it. Both are genuine gay
    # bars, so every post is a trusted LGBTQ source (no keyword filter).
    {
        "username": "thebarcomplex",
        "alt_usernames": ["the.bar.complex", "barcomplex"],  # handle documented both ways; try each so a typo never zeroes the main gay bar
        "source_name": "bar_complex_ig",
        "default_venue": "The Bar Complex, 224 E Main St, Lexington",
        "priority": 2,
        "blurb": "The Bar Complex, Lexington's gay nightclub since 1980. "
                 "Details on Instagram @thebarcomplex.",
    },
    {
        "username": "crossingslexington",
        "alt_usernames": ["crossings_lexington"],
        "source_name": "crossings_ig",
        "default_venue": "Crossings Lexington, 117 N Limestone",
        "priority": 2,
        "blurb": "Crossings Lexington, LGBTQ+ dive bar with drag, lesbian, and "
                 "leather nights. Details on Instagram @crossingslexington.",
    },
]
