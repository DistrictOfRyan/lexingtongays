"""Scraper for Lexington LGBTQ+ bars: Lexington Eagle.

NOTE: YBR (ybrlexington.com), Majestic (majesticlexington.com), Studio 66 (s66lexington.com),
and Lexington House of Drag (lexingtonhouseofdrag.com) are DNS-dead as of 2026 and have
been removed. Lexington Eagle website is attempted as a fallback.

Facebook scraping is disabled (blocked). Check bar Facebook pages manually:
- Lexington Eagle: https://www.facebook.com/TheLexingtonEagle/
- YBR: https://www.facebook.com/YBRLexington/
- Club Majestic: https://www.facebook.com/clubmajesticlexington/
"""
...
class LexingtonEagleScraper(BaseScraper):
    """Scrape events from Lexington Eagle website."""

    source_name = "lexington_eagle"

    FALLBACK_URLS = [
        "https://www.lexingtoneagle.com/events",
        "https://www.lexingtoneagle.com/calendar",
        "https://www.lexingtoneagle.com",
    ]
    ...
    def scrape(self) -> List[Dict]:
        ...
        if not events:
            logger.info(
                "[lexington_eagle] No events found. "
                "Check manually: https://www.facebook.com/TheLexingtonEagle/"
            )
