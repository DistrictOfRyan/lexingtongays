...
def run_all_scrapers() -> List[Dict]:
    ...
    scrapers = [
        ...
        ("slack_browser_scraper", slack_browser_scraper.scrape),  # LexingtonRemote Slack -- browser-extracted JSON or flag
    ]
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("Lexington Gays Event Scraper - Starting")
