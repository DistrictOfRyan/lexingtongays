"""Dedicated scrapers for specific Lexington LGBTQ organizations.

Covers: PFLAG Lexington, Black Queer Lexington, Freedom Oklahoma, Council Oak Men's Chorale,
HotMess Sports, Circle Cinema (filtered), Magic City Books (filtered),
All Souls Unitarian (special events), ULexington Pride Club, OSU Lexington events,
...
class PFLAGLexingtonScraper(BaseOrgScraper):
    source_name = "pflag_lexington"
    BASE_URL = "https://pflag.org"
    EVENTS_URL = "https://pflag.org/chapter/pflag-lexington/"
    DEFAULT_VENUE = "110 S Hartford Ave, Lexington"
    PRIORITY = 1


class BlackQueerLexingtonScraper(BaseOrgScraper):
    """Stub -- handled by playwright_scrapers.BlackQueerLexingtonScraper."""
    source_name = "black_queer_lexington"
    BASE_URL = "https://www.blackqueerlexington.org"
    EVENTS_URL = "https://www.blackqueerlexington.org/events"
    DEFAULT_VENUE = "Various locations, Lexington"
    PRIORITY = 1

    def scrape(self) -> List[Dict]:
        logger.info("[specific_orgs] black_queer_lexington: handled by playwright_scrapers")
        return []
...
class FreedomOklahomaScraper(BaseOrgScraper):
    ...
    DEFAULT_VENUE = "Oklahoma City / Lexington area"
    PRIORITY = 2
...
class CouncilOakScraper(BaseOrgScraper):
    ...
    DEFAULT_VENUE = "Lexington Performing Arts Center"
    PRIORITY = 1
...
class HotMessSportsScraper(BaseOrgScraper):
    ...
    EVENTS_URL = "https://www.hotmesssports.com/lexington"
    DEFAULT_VENUE = "Various venues, Lexington"
    PRIORITY = 2
...
class CircleCinemaScraper(BaseOrgScraper):
    ...
    DEFAULT_VENUE = "Circle Cinema, Lexington"
    PRIORITY = 2
    FILTER_LGBTQ = True
...
class MagicCityBooksScraper(BaseOrgScraper):
    ...
    DEFAULT_VENUE = "Magic City Books, Lexington"
    PRIORITY = 2
    FILTER_LGBTQ = True
...
class ULexingtonPrideClubScraper(BaseOrgScraper):
    source_name = "ulexington_pride"
    BASE_URL = "https://calendar.ulexington.edu"
    EVENTS_URL = "https://calendar.ulexington.edu/organization/pride-club/"
    DEFAULT_VENUE = "University of Lexington Campus"
    PRIORITY = 2


class OSULexingtonScraper(BaseOrgScraper):
    source_name = "osu_lexington"
    BASE_URL = "https://events.lexington.okstate.edu"
    EVENTS_URL = "https://events.lexington.okstate.edu"
    DEFAULT_VENUE = "OSU Lexington Campus, 700 N Greenwood Ave"
    PRIORITY = 2
    FILTER_LGBTQ = True
...
class TwistedArtsScraper(BaseOrgScraper):
    ...
    DEFAULT_VENUE = "Circle Cinema / Twisted Arts Lexington"
    PRIORITY = 1
