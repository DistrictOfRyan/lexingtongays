...
Three source types:
  SEARCH_URLS  -- facebook.com/events/search?q=... (LGBTQ + broad Lexington)
  PAGE_URLS    -- specific venue/org Facebook page event tabs
  GROUP_URLS   -- Lexington LGBTQ+ Facebook group event tabs

lexingtongays.com covers all Lexington events of interest to the queer community,
...
# ── Event searches ─────────────────────────────────────────────────────────────
# All always_include=True: the blog covers all Lexington community events, not just LGBTQ.
SEARCH_URLS = [
    # Explicitly queer
    ("https://www.facebook.com/events/search?q=lgbtq+lexington", True),
    ("https://www.facebook.com/events/search?q=queer+lexington", True),
    ("https://www.facebook.com/events/search?q=drag+lexington", True),
    ("https://www.facebook.com/events/search?q=gay+lexington", True),
    ("https://www.facebook.com/events/search?q=trans+lexington", True),
    ("https://www.facebook.com/events/search?q=pride+lexington", True),
    # Broad Lexington community events (no keyword filter -- we want it all)
    ("https://www.facebook.com/events/search?q=lexington+live+music", True),
    ("https://www.facebook.com/events/search?q=lexington+brunch", True),
    ("https://www.facebook.com/events/search?q=lexington+dance+party", True),
    ("https://www.facebook.com/events/search?q=lexington+comedy", True),
    ("https://www.facebook.com/events/search?q=lexington+karaoke", True),
    ("https://www.facebook.com/events/search?q=lexington+trivia", True),
    ("https://www.facebook.com/events/search?q=lexington+art", True),
    ("https://www.facebook.com/events/search?q=lexington+open+mic", True),
    ("https://www.facebook.com/events/search?q=lexington+happy+hour", True),
    ("https://www.facebook.com/events/search?q=lexington+concert", True),
    ("https://www.facebook.com/events/search?q=lexington+festival", True),
    ("https://www.facebook.com/events/search?q=lexington", True),
]
...
GROUP_URLS = [
    ...
    "https://www.facebook.com/groups/lexingtonartists/events",             # Lexington Artists
    # Music & shows groups
    "https://www.facebook.com/groups/1996680830384050/events",         # Lexington Concerts and Music Events
    "https://www.facebook.com/groups/862121663843106/events",          # Lexington Events and Music Promotions
    # General events / community
    "https://www.facebook.com/groups/114530202225051/events",          # Lexington Events (LEXINGTON EVENT)
    "https://www.facebook.com/groups/2974145312757018/events",         # Lexington Conscious Community and Events
]
    ...
    def _parse_text_blocks(self, full_text: str, link_names: Dict[str, str], ordered_ids: List[str], always_include: bool) -> List[Dict]:
        ...
        while i < len(lines):
            ...
            while j < min(i + 7, len(lines)):
                ...
                if not name:
                    name = candidate
                elif venue == "Lexington, KY" and not re.search(r'interested|going', lower):
                    venue = candidate
                    break
