"""Scraper for QLIST app - LGBTQ+ event aggregator for Lexington."""
...
class QListScraper(BaseScraper):
    """Scrape events from qlist.app for Lexington.

    qlist renders each event as a `.cluster-event` div (wrapped in an
    /events/Lexington/<slug>/<id> anchor) with inline-styled children: a bold
    ...
    source_name = "qlist"
    URL = "https://qlist.app/cities/Oklahoma/Lexington/163"
