"""
Lexington Gays Facebook posting targets (curated registry).

This is the allowlist the automated group blaster (posting/group_blast.py)
posts the weekly carousel into, AS the Lexington Gays Page (never a personal
...
open facebook.com/groups/joins/ while acting as the Lexington Gays Page and run
...
---------------
  ...
  type      : "lgbtq"      Lexington/OK LGBTQ groups (top priority)
              "lgbtq_okc"  OKC-area LGBTQ (statewide / big Pride events)
              "general"    non-LGBTQ Lexington events audiences (still on-topic)
...
FB_GROUPS = [
    ...
    {"name": "Lexington's LGBT Nightlife", "id": "220878821301627", "members": 2000,
     "type": "lgbtq", "post": True, "moderated": False,
     "notes": "Nightlife focus. Went LIVE 2026-06-01."},
    {"name": "Gay Lexington", "id": "GayLexington", "members": 428,
     "type": "lgbtq", "post": True, "moderated": False,
     "notes": "Discrete Lexington group. Went LIVE 2026-06-01."},
    {"name": "Gay men of Lexington", "id": "161646500587551", "members": 1400,
     "type": "lgbtq", "post": True, "moderated": False,
     "notes": "Men-focused, broadly relevant. Went LIVE 2026-06-01."},
    {"name": "Lexington LGBTQ+ Scene", "id": "715281449025002", "members": 3100,
    ...
    {"name": "Lexington Two Spirit", "id": "lexington2s", "members": 181,
     "type": "lgbtq", "post": True, "moderated": True,
    ...
    {"name": "Gay, Lesbian and Bisexual 21+ Lexington KY",
    ...
    # ---- General Lexington events audiences (on-topic for an events roundup) ----
    {"name": "What's Up Lexington?", "id": "WhatsHappeningLexington", "members": 8400,
     "type": "general", "post": True, "moderated": False,
     "notes": "Huge general Lexington events group. Went LIVE 2026-06-01."},
    ...
    {"name": "Stand Up and Shop Local - Support Lexington Small Business",
     "id": "200597954582833", "members": 84500,
     "type": "general", "post": True, "moderated": True,
     "notes": "84.5K Lexington small-biz support group; LGBTQ events are on-topic as they "
              "drive venue foot traffic. Moderated. Pending 2026-06-02. "
              "Use venue-centric caption angle (lexingtongays.com drives foot traffic)."},
    {"name": "Interesting Things To Do In Lexington", "id": "InterestingThingsToDoInLexington",
     "members": 73200, "type": "general", "post": True, "moderated": True,
     "notes": "73K, huge reach. Moderated. Pending 2026-06-01."},
    {"name": "Lexington Events", "id": "114530202225051", "members": 6500,
     "type": "general", "post": True, "moderated": True,
     "notes": "6.5K general Lexington. Moderated. Pending 2026-06-01."},

    # ---- Skipped: BLOCK Page accounts entirely (would need a personal
    #      profile -> forbidden by the anonymity rule). Verified 2026-06-01. ----
    {"name": "Black Queer (Lexington)", "id": "436526440885847", "members": 368,
    ...
    {"name": "LGBT Things for Sale Gay World Lexington Ok", "id": "609390832473854",
     "members": None, "type": "lgbtq", "post": False, "moderated": None,
    ...
    {"name": "Lexingtonns for Lexington - Supporting Local Business", "id": "lexingtonns4lexington",
     "members": None, "type": "general", "post": False, "moderated": None,
     "notes": "Business-support group, tangential."},
    {"name": "Lexington Entrepreneurs", "id": "lexingtonentrepreneurs",
     "members": None, "type": "general", "post": False, "moderated": None,
...
def get_post_targets(include_okc=True, include_general=True):
    ...
    include_okc / include_general let a caller restrict to Lexington-LGBTQ only.
    Ordered: lgbtq (Lexington) first, then okc, then general — and within each,
...
if __name__ == "__main__":
    print(f"Lexington Gays Page: {FB_PAGE_URL}")
