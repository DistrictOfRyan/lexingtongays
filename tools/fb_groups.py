"""
Lexington Gays Facebook posting targets.
...
The page URL to use is FB_PAGE_URL — the /lexingtongays vanity URL does not
...
#   type    : "lgbtq" for Lexington/OK LGBTQ groups, "lgbtq_okc" for OKC-area
#
# Posting priority: lgbtq (Lexington) first, lgbtq_okc second.
...
FB_GROUPS = [
    ...
    {
        "name": "Lexington LGBTQ+ Scene",
        "id": "715281449025002",
        "members": 2900,
        "type": "lgbtq",
        "notes": "Lexington-specific. Good local engagement.",
    },
    {
        "name": "Lexington's LGBT Nightlife",
        "id": "220878821301627",
        "members": 1900,
        "type": "lgbtq",
    ...
    {
        "name": "Bi or gays in lexington party and play",
        "id": "TBD",
        "members": 203,
        "type": "lgbtq",
    ...
    },
    {
        ...
        "members": 14000,
        "type": "lgbtq_okc",
        "notes": "Largest OKC group. Post for big Lexington events with statewide draw.",
    },
]
...
def get_lexington_groups():
    """Return confirmed Lexington LGBTQ groups only (excludes OKC)."""
