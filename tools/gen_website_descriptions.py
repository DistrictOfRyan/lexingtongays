...
_FIVE_FL = [
    ...
    'osu lexington queer', 'pflag lexington', 'queer support',
    'pflag', 'lambda unity',
...
NAMED_DESCRIPTIONS = {
    "homo hotel happy hour": (
        ...
        "downtown hotel bar and turns it into the most genuinely welcoming room in Lexington for "
        ...
        "raising money for Paws in Need Lexington, which provides vet care, food, and support for pets "
    ...
    "monday movie night": (
        "Free movie night at one of Lexington's most beloved gay bars. Tonight it's a punk rock "
    ...
    "dragnificent": (
        ...
        "Club Majestic's DRAGNIFICENT is the Thursday-night anchor of Lexington's queer nightlife, "
    ...
    "osu lexington queer support group": (
        "The OSU Lexington Queer Support Group meets on campus on Tuesday evenings at 6 PM, open to "
        "OSU Lexington students and the broader community, and it is not a club meeting with an agenda "
        ...
        "If you're queer and in Lexington and you've been feeling a little isolated, which is one of "
    ...
    "equality business alliance": (
        ...
        "professionals in Lexington are building real things together and this is how you get to "
        "be part of that."
    ),
    "queer women's collective": (
        "The Queer Women's Collective meetup is at the Equality Center and if you are a queer "
        "woman or femme in Lexington, I genuinely need you to stop finding reasons to skip this. "
    ...
    "pflag lexington": (
        "PFLAG Lexington's monthly meeting is one of the most important gatherings in this city for "
    ...
    "lambda unity": (
        ...
        "quite built for you. "
        "If you are in recovery or considering it, this is one of the most affirming spaces Lexington "
    ...
    "drag bingo": (
        ...
        "Money raised goes to Adonia, an LGBTQ+ youth organization doing real work in Lexington. "
    ...
    "lexington eagle leather night": (
        "Leather Night at the Lexington Eagle with DJ Kudos. The Lexington Eagle is Lexington's leather and "
    ...
    "lexington eagle bingo": (
        "Bingo at the Lexington Eagle on a Saturday afternoon, which sounds like it might be an "
        ...
        "Come in. Grab a card. Find out what Lexington's leather community is actually like when "
        "they're calling B-7 and gossiping warmly between rounds."
    ),
    "kentuck derby": (
        "Kentucky Derby Watch Party and Derby Hat Contest at the Lexington Eagle. The Kentucky Derby "
        ...
        "The Lexington Eagle is the right venue for this. Bring your most outrageous derby hat "
    ...
    "sunday shenanigans": (
        "SUNDAY SHENANIGANS W/ SHANEL at the Lexington Eagle, which is the unofficial close-out-the-"
        "weekend-properly event for Lexington's queer nightlife scene and has been for long enough "
    ...
    "touchtunes friday": (
        "TOUCHTUNES FRIDAY at the Lexington Eagle, which is the night where you and everyone else in "
    ...
    "shenanigans w/ shanel": (
        "SUNDAY SHENANIGANS W/ SHANEL at the Lexington Eagle, which is the unofficial "
        "close-out-the-weekend-properly event for Lexington's queer nightlife scene and has been "
    ...
    "legendary midnight drags": (
        "Lexington's Legendary Midnight Drags at Lexington Raceway Park, and yes, these are car drags, "
        "not the drag you were thinking of. Big engines. Green lights. Lexington's outdoor street "
    ...
    "a people's museum": (
        "A People's Museum by AK/OK at Positive Space Lexington. This is an international living "
        ...
        "Lexington is exactly the right venue for this. Go this Saturday. Let it actually hit you."
    ),
    ...
    "pump bar": (
        "Pump Bar on South Lewis is a Lexington LGBTQ+ institution, and whatever the occasion is "
        "tonight, a party there is exactly the kind of community gathering that reminds you why "
        "Lexington's gay bar scene matters and why showing up to your local bar is never actually "
    ...
    "muumuus": (
        ...
        "This is the gay-coded social event the internet would have invented if the Lexington queer "
    ...
    "gypsy": (
        "Gypsy the Musical at the Lexington Performing Arts Center. Everything's Coming Up Roses. "
        ...
        "If you love musical theater, this is one you see, full stop, and the Lexington Performing "
    ...
    "mahler": (
        "Mahler's Symphony No. 2, 'Resurrection,' at the Lexington Performing Arts Center. The "
    ...
    "gillian welch": (
        ...
        "which is one of Lexington's best outdoor venues for exactly this kind of show. "
    ...
    "first friday art crawl": (
        "First Friday Art Crawl in the Lexington Arts District, which happens once a month and "
        ...
        "that Lexington's arts community tends to be, and the whole evening functions as a genuine "
    ...
    "loony bin": (
        "Comedy show at the Loony Bin. The Loony Bin is Lexington's established comedy club and "
    ...
    "cindy kaza": (
        ...
        "Lexington this week, and comedy shows at the Loony Bin are a reliable outing because the "
    ...
    "drew dunn": (
        ...
        "Lexington's main comedy club, and a touring act means material that is fresher than the "
    ...
    "rooftop concert": (
        "Rooftop Concert Series at Soma Lexington: BRANJAE is a Lexington musician with a following "
        ...
        "Live music in Lexington is genuinely underrated, and this is exactly the kind of show "
    ...
    "sunset cinema": (
        ...
        "Circle Cinema is Lexington's beloved independent movie house, which means this is a free "
    ...
    "queen bess": (
        ...
        "would accept her. Lexington is honoring her centennial with a free silent film and live "
        "musical performance. "
    ...
    "urban sketchers": (
        "Urban Sketchers Lexington meet-up at Mother Road Market. Urban Sketchers is an "
    ...
    "lexington indian club": (
        "Lexington Indian Club Spring Festival: Native Arts and Crafts, Indian Tacos and More at "
    ...
    "craft & drafts": (
        ...
        "is a Lexington brewery with a good reputation, and combining crafts with draft beer on a "
    ...
    "ok so lexington": (
        "Ok So Lexington Grand Slam: Lexington's Best Storyteller Competition at Cain's Ballroom. "
    ...
    "all souls unitarian": (
        "All Souls Unitarian Sunday Services. All Souls in Lexington is one of the most LGBTQ-"
        ...
        "will engage with you fully, All Souls is worth showing up to. Many queer Lexingtonns "
    ...
    "antiracist support group": (
        "Lexington Antiracist Support Group at Zarrow Library. This is a group of people committed "
    ...
    "archer creatives": (
        "First Friday on Archer: Archer Creatives pop-up in the Lexington Arts District. The arts "
    ...
    "painters outing": (
        ...
        "didn't bother. "
        "Philbrook is one of Lexington's great gifts, a real museum in a mansion and garden that "
    ...
    "little big town": (
        ...
        "lines throughout. If you are a country music fan in Lexington's queer community, this "
    ...
    "frequency lounge": (
        ...
        "Frequency Lounge is a Lexington bar with a following, and Wednesday karaoke there draws "
    ...
    "eerie abbey": (
        "Trivia Night at Eerie Abbey Ales Downtown. Eerie Abbey is a Lexington craft brewery with "
...
def _desc_drag(ev, score):
    ...
    v = ev.get('venue', '')
    return (
        f"{n} at {v}. Drag is Lexington's most reliably spectacular live performance art, and this "
        ...
        "Drag shows in Lexington are run by real artists doing real work, and showing up and being "
...
def _desc_art(ev, score):
    ...
    return (
        f"{n} at {v if v else 'a local gallery'}. Art openings and crawls are where Lexington's "
...
def _desc_concert(ev, score):
    ...
    return (
        f"{n} at {v if v else 'a local venue'}. Live music in Lexington is better than it gets "
...
def _desc_festival(ev, score):
    ...
    return (
        ...
        "Lexington needs more of: reasons for different kinds of people to be in the same "
...
def _ybr_inclusive_note(ev) -> str:
    """The line William wants on every YBR event (2026-06-20): YBR is Lexington's only
    ...
    if "yellow brick" in blob or ev.get("source") == "ybr_ig" or " ybr" in f" {blob}":
        return (
            ...
            "Lexington's only lesbian bar and one of the last left in the country, and it "
...
# A bare city/state is not a venue and reads badly as "at Lexington, KY".
_NON_VENUE_RE = re.compile(
    r'^(lexington|broken arrow|jenks|owasso|bixby|sand springs|sapulpa)'
...
def _generate_sassy_descriptions(ev: dict, score: int) -> tuple:
    ...
    try:
        ...
        prompt = f"""You write event descriptions for Lexington Gays, a website helping LGBTQ+ people in Lexington, KY find things to do.
