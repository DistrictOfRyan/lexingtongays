...
NAMED_DESCRIPTIONS = {
    "homo hotel happy hour": (
        ...
        "downtown hotel bar into the most welcoming room in Lexington for two glorious hours. "
        "This month HHHH is raising money for Paws in Need Lexington, which provides vet care, food, "
        ...
        "No cover. No dress code. Just the most fabulous two hours Lexington offers every month."
    ),
    ...
    "gender outreach support group": (
        ...
        "important gatherings in Lexington's LGBTQ+ community: the Gender Outreach Support Group. "
    ...
    "osu lexington queer support group": (
        "The OSU Lexington Queer Support Group meets on campus for students, staff, and community "
        ...
        "Open to OSU Lexington students AND the broader community. "
        "If you're queer and in Lexington and you've been feeling a little isolated, "
    ...
    "equality business alliance": (
        ...
        "LGBTQ+ professionals in Lexington are building real things together. Come be part of it."
    ),
    "queer women's collective": (
        "The Queer Women's Collective May Meetup is happening at the Equality Center and "
        "if you're a queer woman or femme in Lexington, there is genuinely no reason to skip this. "
    ...
    "pflag lexington": (
        "PFLAG Lexington's monthly meeting is one of the most important gatherings in the city "
    ...
    "lambda unity": (
        ...
        "Lexington has to offer. Check the listing for time. Show up. You belong here."
    ),
    "drag bingo": (
        ...
        "Money goes to Adonia, an LGBTQ+ youth organization doing real work in Lexington. "
        "This is the most fun you can have at a table in Lexington on a Saturday night. "
    ...
    "lexington eagle leather night": (
        "Leather Night at the Lexington Eagle with DJ Kudos. "
        "The Lexington Eagle is Lexington's leather and bear bar, and on Leather Night, the vibe is "
        ...
        "This is the Lexington bar experience that doesn't try to be anything other than exactly itself. "
        "Doors late. Energy good. Show up."
    ),
    "lexington eagle bingo": (
        "Bingo at the Lexington Eagle on a Saturday afternoon. "
        ...
        "Come in, grab a card, and see what Lexington's leather community is actually like when "
        "they're calling B-7 and gossiping between rounds."
    ),
    "kentuck derby": (
        "Kentucky Derby Watch Party and Derby Hat Contest at the Lexington Eagle. "
        "The most extra afternoon of the sports calendar, held at one of Lexington's most "
    ...
    "sunday shenanigans": (
        "SUNDAY SHENANIGANS W/ SHANEL at the Lexington Eagle. "
        ...
        "This is the unofficial 'close out the weekend properly' event for Lexington's queer nightlife scene. "
    ...
    "touchtunes friday": (
        "TOUCHTUNES FRIDAY at the Lexington Eagle. "
        ...
        "and Fridays there have a loose, anything-goes energy that's hard to find anywhere else in Lexington. "
    ...
    "legendary midnight drags": (
        "Lexington's Legendary Midnight Drags at Lexington Raceway Park. "
        "These are not the drag you're thinking of. These are cars. Big engines. Green lights. "
        "Lexington's outdoor street drag racing tradition happens monthly at the Raceway Park, "
    ...
    "a people's museum": (
        "A People's Museum by AK/OK at Positive Space Lexington. "
        ...
        "just say 'have you been?' Positive Space Lexington is the right venue for it. "
    ...
    "pump bar": (
        ...
        "Pump Bar is a Lexington LGBTQ+ institution on South Lewis, and a birthday party there "
        "is exactly the kind of community celebration that reminds you why Lexington's gay bar scene matters. "
    ...
    "gypsy": (
        "Gypsy the Musical at the Lexington Performing Arts Center. "
        ...
        "If you love musical theater, this is one you see. The Lexington Performing Arts Center is "
    ...
    "mahler": (
        "Mahler's Symphony No. 2, 'Resurrection' at the Lexington Performing Arts Center. "
    ...
    "gillian welch": (
        ...
        "and at Guthrie Green, one of Lexington's best outdoor venues. "
    ...
    "trivia": (
        "Trivia night. "
        "Trivia nights in Lexington's bar scene are a reliable Wednesday or Thursday hang — "
    ...
    "first friday art crawl": (
        "First Friday Art Crawl in the Lexington Arts District. "
    ...
    "loony bin": (
        ...
        "The Loony Bin is Lexington's established comedy club and they bring in touring acts regularly. "
    ...
    "cindy kaza": (
        ...
        "Cindy Kaza is a touring comedian playing Lexington this week. "
    ...
    "drew dunn": (
        ...
        "Stand-up comedy on a Wednesday night at Lexington's main comedy club. "
    ...
    "rooftop concert": (
        "Rooftop Concert Series at Soma Lexington: Brut Hotel | Soma feat. BRANJAE. "
        "BRANJAE is a Lexington musician with a following for a reason — the combination of "
        ...
        "Live music in Lexington is genuinely underrated, and this is the kind of show "
    ...
    "sunset cinema": (
        ...
        "Circle Cinema is Lexington's beloved independent movie house, which means this is "
    ...
    "queen bess": (
        ...
        "Lexington is honoring her centennial with a free silent film and live musical performance. "
    ...
    "urban sketchers": (
        "Urban Sketchers Lexington May Meet-up at Mother Road Market. "
    ...
    "lexington indian club": (
        "Lexington Indian Club Spring Festival: Native Arts & Crafts, Indian Tacos & More at Jenks Riverwalk. "
        "This is a genuine community cultural festival celebrating Native arts, food, and tradition "
        "along the Jenks Riverwalk. "
        "The Lexington Indian Club has been running these events for decades, and the festival draws "
    ...
    "craft & drafts": (
        ...
        "Cabin Boys is a Lexington brewery with a good reputation, and combining crafts with draft beer "
    ...
    "ok so lexington": (
        "Ok So Lexington Grand Slam: 12th Lexington's Best Storyteller Competition at Cain's Ballroom. "
    ...
    "all souls unitarian": (
        ...
        "All Souls Unitarian in Lexington is one of the most LGBTQ-affirming congregations in the city — "
        ...
        "Many queer Lexingtonns have found genuine community here. "
    ...
    "antiracist support group": (
        "Lexington Antiracist Support Group at Zarrow Library. "
    ...
    "archer creatives": (
        ...
        "The Lexington Arts District on First Friday is the most walkable, social, "
    ...
    "painters outing": (
        ...
        "and Philbrook is one of Lexington's great gifts — a real museum in a mansion and garden "
    ...
    "little big town": (
        ...
        "If you're a country music fan in Lexington's queer community, this is the show. "
    ...
    "frequency lounge": (
        ...
        "Frequency Lounge is a Lexington bar with a following, and Wednesday karaoke there "
    ...
    "eerie abbey": (
        ...
        "Eerie Abbey is a Lexington craft brewery with solid beers and regular events. "
...
def _desc_drag(ev, score):
    ...
    return (
        f"{n} at {v}. "
        "Drag is Lexington's most reliably spectacular live performance art, and this is your invitation "
        ...
        "Drag shows in Lexington are run by real artists doing real work, "
...
def _desc_art(ev, score):
    ...
    return (
        ...
        "Art openings and crawls are where Lexington's creative community actually gathers, "
...
def _desc_concert(ev, score):
    ...
    return (
        ...
        "Live music in Lexington is better than it gets credit for, and this is the kind of show "
...
def _desc_festival(ev, score):
    ...
    return (
        f"{n} at {v if v else 'a local venue'}. "
        "Community festivals are exactly what Lexington needs more of: "
...
def _generate_sassy_descriptions(ev: dict, score: int) -> tuple:
    ...
    try:
        ...
        prompt = f"""You write event descriptions for Lexington Gays, a website helping LGBTQ+ people in Lexington KY find events.
