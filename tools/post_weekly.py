...
# GitHub Pages public URL base (www.lexingtongays.com is the custom domain)
SITE_BASE  = f"https://www.lexingtongays.com/posts/{WEEK_KEY}"

WEEK_OPENERS = [
    "Okay. We need to talk about what's happening in Lexington this week.",
    "Your calendar needs clearing. At least one night. Actually all of them.",
    "Lexington is doing the absolute most this week and we are completely here for it.",
    "Leave the house. We've given you zero reasons not to.",
    "This week in Lexington? Fully undefeated. Here's what's on the agenda.",
...
def host_slides_for_ig(slides: list[Path]) -> list[str]:
    ...
    The docs/ folder is served via GitHub Pages at www.lexingtongays.com.
...
def main():
    print("=" * 60)
    print(f"LEXINGTON GAYS — POST WEEKLY CAROUSEL ({WEEK_KEY})")
    if DRY_RUN:
    ...
    print("\n[HOSTING] Publishing slides to lexingtongays.com...")
    ...
    print("Switch to Lexington Gays page identity first. Then for each group:")
    print("  - Open group, Create post, attach all 9 images in order, add sassy EOTW caption, post.")
    print("Groups (11 total):")
    print("  1.  Gay men of Lexington          groups/161646500587551")
    print("  2.  Okie Gays                 groups/2612250565491228")
    print("  3.  Lexington LGBTQ+ Scene        groups/715281449025002")
    print("  4.  Gay Lexington                 groups/GayLexington")
    print("  5.  Lexington's LGBT Nightlife    groups/220878821301627")
    print("  6.  Black Queer Lexington         groups/436526440885847")
    print("  7.  Oklahoma Lesbian Friends  groups/649753022551343")
    print("  8.  Oklahoma House of Drag    groups/418182474119895")
    print("  9.  Interesting Things Lexington  groups/InterestingThingsToDoInLexington")
    print("  10. What's Up Lexington?          groups/WhatsHappeningLexington")
    print("  11. Lexington Events              groups/114530202225051")
