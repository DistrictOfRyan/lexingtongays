...
def main():
    ...
    print("=" * 60)
    print("Facebook Login Helper -- Lexington Gays Event Scraper")
    print("=" * 60)
    print()
    print("A browser will open. Log in to Facebook as the Lexington Gays")
    print("account (or any account that can see LGBTQ Lexington events).")
    print()
