"""
Pre-post preflight for the Lexington Gays weekly carousel.
...
# Real Lexington venues/events whose OWN NAME contains a soft identity term. These
...
# 224 N Main St, Lexington — confirmed on downtownlexington.com 2026-08-10).
...
def run(week_key=None):
    ...
    # (Re-scoped 2026-06-15 — see feedback_lexingtongays_featured_gay_first.)
