...
INJECTIONS = {
    ...
    "elote": (
        ...
        "Elote is one of Lexington's most queer-friendly spots and events there reflect it. "
    ...
    "pride bar crawl": (
        "The Lexington Pride Bar Crawl is the event where the entire queer community "
        ...
        "Lexington Pride Bar Crawl: the whole queer community moving through downtown together. "
    ...
    "black. queer. proud.": (
        ...
        "in Lexington's queer landscape.",
