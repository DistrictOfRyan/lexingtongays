...
INJECTIONS = {
    "homo hotel happy hour": (
        ...
        "transforms a downtown hotel bar into the most welcoming room in Lexington for two glorious hours. "
        "This month HHHH is raising money for Paws in Need Lexington, vet care and food support for pets "
        ...
        "First Friday. The DoubleTree. The gays, raising money for Paws in Need Lexington. "
    ...
    "twisted arts drag bingo": (
        ...
        "some of the best drag Lexington has to offer. "
        ...
        "This is the Saturday Lexington drag scene that actually shows up.",
    ),
    "okeq senior": (
        "OKEQ's Senior Program at the Equality Center is one of Lexington's most quietly important "
    ...
    "positively grateful": (
        ...
        "This is low-pressure, inclusive, and held in one of Lexington's most affirming spaces. "
    ...
    "okeq lexington ttrpg": (
        "OKEQ is running a Tabletop RPG session at the Equality Center and this is the "
        "nerd-gay overlap event Lexington didn't know it needed to put on a flyer. "
    ...
    "girl scout troop": (
        ...
        "Girl Scout Troop 7484 meets at the Equality Center, one of Lexington's most affirming spaces. "
    ...
    "live music - ryan graham": (
        ...
        "Live music in Lexington's bar scene is genuinely underrated, and Friday nights at 601 "
        ...
        "Lexington has better live music than it gets credit for. This is evidence.",
    ),
    ...
    "elote": (
        "Elote is one of Lexington's most LGBTQ-friendly venues and when they host events, "
        ...
        "Elote is one of Lexington's most LGBTQIA+-friendly spots and events there reflect it. "
    ...
    "inner circle drag show": (
        ...
        "Lexington drag outside of the big venues, this is your wake-up call. "
    ...
    "pride bar crawl": (
        "The Lexington Pride Bar Crawl is the event where the entire LGBTQIA+ community "
        ...
        "Lexington Pride Bar Crawl: the whole LGBTQIA+ community moving through downtown together. "
    ...
    "black. queer. proud.": (
        ...
        "the community that deserves to take up space in Lexington. "
        ...
        "in Lexington's LGBTQIA+ landscape.",

        "Black. Queer. Proud. is the community gathering that the city needs and that "
        "Black LGBTQ+ Lexingtonns deserve. Show up. Be present. This matters.",
    ),
    ...
    "scavenger hunt": (
        "The Self-Care City Scavenger Hunt takes you through Lexington on a mission, "
        ...
        "Self-Care City Scavenger Hunt through Lexington: exploration, competition, "
