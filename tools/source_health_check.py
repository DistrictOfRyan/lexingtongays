"""
Source health pre-flight check for the Lexington Gays event scraper.
...
TIMEOUT = 10
USER_AGENT = (
    "Mozilla/5.0 (compatible; LexingtonGays-HealthCheck/1.0; "
    "+https://www.lexingtongays.com)"
)
...
def run() -> list:
    ...
    print("=" * 68)
    print("LEXINGTON GAYS SOURCE HEALTH CHECK")
