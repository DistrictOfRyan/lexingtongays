"""
Pre-slide verification for the Lexington Gays weekly pipeline.
...
DOUBLETREE_VENUE = "DoubleTree Lexington Downtown"
...
def _flamingo_score(ev: dict) -> int:
    ...
    _FIVE_KW = [
        ...
        "osu lexington queer", "pflag lexington", "queer support", "pflag", "lambda unity",
...
def run_verification(week_key: str) -> int:
    ...
    """
    print(f"\n{'=' * 50}")
    print("  LEXINGTON GAYS WEEKLY VERIFICATION")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Pre-slide verification for the Lexington Gays weekly pipeline."
    )
    parser.add_argument(
        "--week",
