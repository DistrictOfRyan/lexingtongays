"""
LexingtonGays weekly newsletter -> Kit (nextlevel Rung 2: Owned Audience).
...
def build_email(week_key):
    ...
    subj = f"This week in queer Lexington: {eotw.get('name', 'your LGBTQ+ calendar')}"
    ...
    parts.append(f'<p style="margin-top:26px"><a href="{SITE}" style="background:#e6007e;color:#fff;'
                 f'padding:10px 18px;border-radius:6px;text-decoration:none">See every event at lexingtongays.com &rarr;</a></p>')
    parts.append('<p style="color:#999;font-size:12px;margin-top:24px">You\'re getting this because you '
                 'wanted Lexington\'s queer calendar in your inbox. Pace yourself, hydrate, look out for each other.</p>')
    parts.append('</div>')
