...
DESCS = {
    ...
    "queen bess centennial aviation arts festival": (
        ...
        "Lexington is honoring her centennial with a free silent film and live performers. "
    ...
    "drag bingo fundraiser for adonia": (
        ...
        "helps Adonia. This is the most fun you can have at a table in Lexington on a Saturday. "
        "Buy a card. Tip your queen. Scream when you win."
    ),
    "legendary midnight drags": (
        "Cars line up. Lights go green. The crowd actually loses it. Lexington's street drag "
    ...
    "okeq seniors": (
        ...
        "and connection. If you're a queer elder in Lexington, you should absolutely be in this room."
    ),
    ...
    "a people's museum by ak/ok": (
        ...
        "and personal stories. At Positive Space Lexington. This is the kind of art that makes you "
    ...
    "dragnificent! drag show": (
        ...
        "your mind in the best possible way. Thursday nights in Lexington don't get better than this."
    ),
    "homo hotel happy hour (hhhh)": (
        "Lexington's queerest happy hour is a First Friday tradition. The Homo Hotel opens its "
        "doors for community, conversation, and cocktails. Whether you're new to Lexington or a "
